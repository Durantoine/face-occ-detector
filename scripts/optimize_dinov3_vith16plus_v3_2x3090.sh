#!/bin/bash
#SBATCH --job-name=face-occ-vith16plus-v3-optuna
...
echo "================================================================================"
echo "OPTUNA HPO - DINOv3 ViT-H+/16 (600M) v3 - le plus gros DINO sur 2x RTX 3090"
echo "================================================================================"
...
export FACE_OCC_ARCH=dinov3-vith16plus-3090-v3
