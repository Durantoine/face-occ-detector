...
#
# Usage:
#   ./scripts/chain_optimize_two.sh                                        # 3 rounds, vitb16+sapiens01b (defaults)
#   ./scripts/chain_optimize_two.sh 3
#   ./scripts/chain_optimize_two.sh 4 scripts/optimize_dinov3_vitb16_v4_2x3090.sh scripts/optimize_sapiens2_01b_v4_2x3090.sh

set -e

N="${1:-3}"
SCRIPT_A="${2:-scripts/optimize_dinov3_vitb16_v4_2x3090.sh}"
SCRIPT_B="${3:-scripts/optimize_sapiens2_01b_v4_2x3090.sh}"
