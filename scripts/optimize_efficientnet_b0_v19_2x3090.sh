#!/bin/bash
#SBATCH --job-name=face-occ-efficientnet-b0-v19-optuna
...
echo "================================================================================"
echo "OPTUNA HPO - EfficientNet-B0 (CNN ~30M) v19 - Baseline CNN (2x 3090, BF16)"
...
export FACE_OCC_ARCH=efficientnet-b0-3090-v19
