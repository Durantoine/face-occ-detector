#!/bin/bash
#SBATCH --job-name=face-occ-sapiens2-01b-v9-optuna
...
echo "================================================================================"
echo "OPTUNA HPO - Sapiens2-0.1B (114M) v9 - 5-axes design + val_split_alpha (2x 3090, BF16)"
...
export FACE_OCC_ARCH=sapiens2-01b-3090-v9
