...
def _list_runs(tracking_uri: str, experiment_id: str) -> List[Dict[str, Any]]:
    ...
    for r in runs:
        ...
        out.append({
            ...
            "challenge_score":     pick("best_score_hc_alpha_0.5", "best_score", "eval_challenge_score"),
...
def _render_trials_comparison() -> None:
    ...
    with st.sidebar:
        ...
        if "best_score_hc_alpha_0.5" in available_metrics:
            default_metric = "best_score_hc_alpha_0.5"
        elif "best_score" in available_metrics:
