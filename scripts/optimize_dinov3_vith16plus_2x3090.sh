#!/bin/bash
#SBATCH --job-name=face-occ-vith16plus-optuna
...
echo "================================================================================"
echo "OPTUNA HPO - DINOv3 ViT-H+/16 - Face Occlusion (2x RTX 3090 DDP, BF16) - NO PRETRAIN"
echo "================================================================================"
...
export FACE_OCC_ARCH=dinov3-vith16plus-3090
