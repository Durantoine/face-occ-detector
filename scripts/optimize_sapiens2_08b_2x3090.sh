#!/bin/bash
#SBATCH --job-name=face-occ-sapiens2-08b-optuna
...
echo "================================================================================"
echo "OPTUNA HPO - Sapiens2-0.8B - Face Occlusion (2x RTX 3090 DDP, BF16) - HF, NO PRETRAIN"
echo "================================================================================"
...
export FACE_OCC_ARCH=sapiens2-08b-3090
