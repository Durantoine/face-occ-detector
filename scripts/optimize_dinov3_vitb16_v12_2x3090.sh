#!/bin/bash
#SBATCH --job-name=face-occ-vitb16-v12-optuna
...
echo "================================================================================"
echo "OPTUNA HPO - DINOv3 ViT-B/16 (86M) v12 - v11 refinements (2x 3090, BF16)"
...
export FACE_OCC_ARCH=dinov3-vitb16-3090-v12
