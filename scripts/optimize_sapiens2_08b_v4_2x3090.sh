#!/bin/bash
#SBATCH --job-name=face-occ-sapiens2-08b-v4-optuna
...
echo "================================================================================"
echo "OPTUNA HPO - Sapiens2-0.8B (800M) v4 - le plus gros Sapiens2 sur 2x RTX 3090"
echo "================================================================================"
...
export FACE_OCC_ARCH=sapiens2-08b-3090-v4
