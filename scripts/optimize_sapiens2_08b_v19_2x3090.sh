#!/bin/bash
#SBATCH --job-name=face-occ-sapiens2-01b-v19-optuna
...
echo "================================================================================"
echo "OPTUNA HPO - Sapiens2-0.8B (671M) v19 - v11 refinements (2x 3090, BF16)"
...
export FACE_OCC_ARCH=sapiens2-08b-3090-v19
