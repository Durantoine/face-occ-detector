#!/bin/bash
#SBATCH --job-name=face-occ-convnextv2-base-3090-v19-refined-optuna
...
echo "================================================================================"
echo "OPTUNA HPO - EfficientNet-B0 (5M) v19 - single GPU (3090)"
...
export FACE_OCC_ARCH=convnextv2-base-3090-v19-refined
