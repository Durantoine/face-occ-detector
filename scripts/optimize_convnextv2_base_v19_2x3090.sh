#!/bin/bash
#SBATCH --job-name=face-occ-convnextv2-base-v19-optuna
...
echo "================================================================================"
echo "OPTUNA HPO - ConvNeXt v2 Base (88M) v19 - Baseline CNN (2x 3090, BF16)"
echo "  Backbone: timm convnextv2_base (ImageNet pretrained)"
...
export FACE_OCC_ARCH=convnextv2-base-3090-v19
