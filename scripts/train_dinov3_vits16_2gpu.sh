#!/bin/bash
#SBATCH --job-name=face-occ-vits16-train
...
echo "================================================================================"
echo "TRAIN - DINOv3 ViT-S/16 - Face Occlusion Regression (2 GPU DDP)"
echo "================================================================================"
...
${TORCHRUN} --nproc_per_node=2 --master_port=$MASTER_PORT src/train.py
