#!/bin/bash
#SBATCH --job-name=face-occ-convnext-v4-optuna
...
echo "================================================================================"
echo "OPTUNA HPO - ConvNeXt v2 Base (88M) - full Optuna HPO (2x RTX 3090, BF16)"
echo "================================================================================"
...
export FACE_OCC_ARCH=convnextv2-base-3090-v4
