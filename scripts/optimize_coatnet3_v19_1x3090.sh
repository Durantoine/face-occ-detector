#!/bin/bash
#SBATCH --job-name=face-occ-coatnet3-3090-v19-optuna
...
echo "================================================================================"
echo "OPTUNA HPO - CoAtNet-3 (167M) v19 - single GPU (3090)"
echo "  Pas de torchrun = pas de DDP, pas d'overhead inter-rank"
echo "  Yaml: gradient_checkpointing=true + batch=24 + grad_accum=2 (effective 48)"
echo "================================================================================"
...
export FACE_OCC_ARCH=coatnet3-3090-v19
