#!/bin/bash
#SBATCH --job-name=face-occ-sapiens2-01b-v14-optuna
...
echo "================================================================================"
echo "OPTUNA HPO - Sapiens2-0.1B (114M) v14 - v11 refinements (2x 3090, BF16)"
...
export FACE_OCC_ARCH=sapiens2-01b-3090-v14
